          ...
          <div className={styles.formInner}>
            ...
            <div className={styles.inputsGroup}>
              <div className={styles.inputField}>
                <label>Електронна пошта або ім'я користувача</label>
                <input type="text" placeholder="lumitune@gmail.com" />
              </div>
              <div className={styles.inputField}>
            ...
            <a href="/" className={styles.loginButton}>Увійти</a>
          </div>

          <div className={styles.registerBlock}>
            <span>Немає аккаунта?</span>
            <a href="/register">Реєстрація у LumiTune</a>
          </div>
        </div>
      </div>
    </div>

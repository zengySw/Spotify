    ...
    <div className={styles.registerPage}>
      ...
      <div className={styles.formContainer}>
        <div className={styles.formWrapper}>
          ...
          <h2 className={styles.title}>Пориньте вперше у LumiTune</h2>

          <div className={styles.inputGroup}>
            <div className={styles.emailField}>
              <label className={styles.emailLabel}>Електронна пошта</label>
              <input className={styles.emailInput} type="email" placeholder="@gmail.com" />
            </div>

            <a href="/step1" className={styles.nextButton}>Далі</a>
          </div>
          ...
          <div className={styles.loginLink}>
            <span>Є аккаунт?</span>
            <a href="/Login">Увійдіть до нього</a>
          </div>
        </div>
      </div>
    </div>

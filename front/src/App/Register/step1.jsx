  ...
  return (
    <div className={styles.registerPage}>
      ...
      <div className={styles.formContainer}>
        <a href="/register" className={styles.backLink}>Назад</a>
        ...
        <div className={styles.formWrapper}>
          ...
          <div className={styles.titleSection}>
            ...
            <p className={styles.step}>Крок 1 із 2</p>
          </div>
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={styles.requirements}>
              <div className={styles.requirementText}>Пароль має містити принаймні:</div>
              ...
              <div className={styles.requirementItem}>
                <div className={styles.checkCircle} />
                <span>1 число або 1 спеціальний символ ㅤㅤㅤㅤㅤ(наприклад: _ ! ? &amp; #)</span>
              </div>
              <div className={styles.requirementItem}>
                <div className={styles.checkCircle} />
            ...
            <a href="/step2" className={styles.nextButton}>Далі</a>
          </div>
        </div>
      </div>
    </div>
